...
import body1 from '../../images/bb-body-1.svg';
                    ...
                    <div className='bb-grid lg align-items-center'>
                        <div className='column column-6 column-offset-1'>
                            <div className='bb-body-parts'>
                                <img className='body-part head' id='bb-head' alt='Placeholder' src={this.imgNameHead}/>
                                <img className='body-part torso' id='bb-body' alt='Placeholder' src={body1}/>
                                <img className='body-part legs' id='bb-legs' alt='Placeholder' src={this.imgNameLegs}/>
                            </div>
                        </div>
                        <div className='column column-6 column-offset-1 text-center intro'>
                            <h1 className='title'>Bearbones</h1>
                            <p className='subtitle'>One of the world‘s most <span className='font-weight-bold'>customisable</span> CSS frameworks.</p>
                            <div className='column m-t-3'>
                                <a className='bb-btn icon primary lg' id='cta-view-docs'>Get started
                                    <span>
                                        <i className='fal fa-chevron-down'></i>
                                    </span>
                                </a>
                                <a className='bb-btn icon primary lg outline hidden-lg-down' href='/documentation'>Docs
                                    <span>
                ...
                <div className='container'>
                    ...
                    <div className='bb-grid md'>
                        <div className='column text-center'>
                            <h2 className='title'>Wanting to develop with a CSS framework without the worry of it looking like everyone elses?</h2>
                        </div>
                    </div>
                    <div className='bb-grid lg m-t-5'>
                        <div className='column one-third text-center-lg text-right'>
                                <p><i className='fal fa-cogs fa-5x text-secondary m-b-3'></i></p>
                                <h3 className='text-secondary title'>Customisable.</h3>
                                <p className='subtitle'>The ability to personalise any components is something that we are truly proud of.</p>
                        </div>                
                        <div className='column one-third text-center-lg'>
                            <p><i className='fab fa-css3 fa-5x text-secondary m-b-3'></i></p>
                            <h3 className='text-secondary title'>Contemporary.</h3>
                            <p className='subtitle'>Built using the latest and greatest tech including Flexbox, Sass and <a href=''>Font Awesome 5</a>.</p>
                        </div>
                        <div className='column one-third text-center-lg'>
                            <p><i className='fal fa-thumbs-up fa-5x text-secondary m-b-3'></i></p>
                            <h3 className='text-secondary title'>Completely Free.</h3>
                            <p className='subtitle'>Open source, surely there is nothing that developers love more than that?</p>
                        </div>
                    </div>
                </div>
            </div>
